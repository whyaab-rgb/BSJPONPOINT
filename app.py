    prev_macd_hist = float(df["MACD_HIST"].iloc[-2]) if len(df) > 1 else macd_hist
    ...
    gain = ((close_ - prev_close) / prev_close * 100) if prev_close else 0
    ...
    if not pd.isna(rsi):
        if 28 <= rsi <= 42:
            score += 22
            notes.append("RSI ideal")
        elif 42 < rsi <= 50:
            score += 12
            notes.append("RSI naik")
        elif rsi < 28:
            score += 8
            notes.append("RSI terlalu dalam")

    if not pd.isna(support) and close_ <= support * 1.06:
        score += 18
        notes.append("Near support")

    if not pd.isna(bb_lower) and close_ <= bb_lower * 1.05:
        score += 14
    ...
    if close_ > prev_close:
        score += 10
        notes.append("Higher close")

    if not pd.isna(macd_hist) and not pd.isna(prev_macd_hist):
        if macd_hist > prev_macd_hist:
            score += 14
            notes.append("MACD naik")
        if macd_hist > 0:
            score += 8
            notes.append("MACD positif")
    ...
    if not pd.isna(rvol):
        if rvol >= 180:
            ...
            score += 10
            notes.append("Volume masuk")

    if not pd.isna(wick) and wick <= 40:
        score += 6

    if not pd.isna(ma20) and close_ < ma20 * 0.90:
        score -= 10
    ...
    entry = round(close_)
    tp = round(close_ + atr * 1.8) if not pd.isna(atr) else round(close_ * 1.04)
    sl = round(support * 0.98) if not pd.isna(support) else round(close_ * 0.96)
...
def build_row(symbol: str, daily_df: pd.DataFrame, intraday_5m: pd.DataFrame):
    ...
    bsjp_detail = compute_bsjp_detail(df)
    return {
        "bsjp_score_v2": bsjp_detail["bsjp_score_v2"],
        "bsjp_label": bsjp_detail["bsjp_label"],
        "bsjp_entry": bsjp_detail["bsjp_entry"],
        "bsjp_tp": bsjp_detail["bsjp_tp"],
        "bsjp_sl": bsjp_detail["bsjp_sl"],
        "bsjp_reason": bsjp_detail["bsjp_reason"],
...
display_df = screener_df.sort_values(
    by=["bsjp_score_v2", "score_accum", "rvol", "gain"],
...
with t2:
    st.subheader("BSJP Engine V2")

    c1, c2, c3, c4, c5 = st.columns(5)
    c1.metric("STATUS", selected_row["bsjp_label"])
    c2.metric("SCORE", int(selected_row["bsjp_score_v2"]))
    c3.metric("ENTRY", fmt_price(selected_row["bsjp_entry"]))
    c4.metric("TP", fmt_price(selected_row["bsjp_tp"]))
    c5.metric("SL", fmt_price(selected_row["bsjp_sl"]))

    df_bsjp = pd.DataFrame([{
        "EMITEN": selected_row["symbol"],
        "STATUS": selected_row["bsjp_label"],
        "SCORE": int(selected_row["bsjp_score_v2"]),
        "PRICE": fmt_price(selected_row["now"]),
        "GAIN": fmt_pct(selected_row["gain"]),
        "RVOL": fmt_pct(selected_row["rvol"]),
        "RSI": rsi_cell_text(selected_row["rsi"]),
        "RSI 5M": rsi_cell_text(selected_row["rsi_5m"]),
        "FASE": selected_row["fase"],
        "TREND": selected_row["trend"],
        "ALASAN": selected_row["bsjp_reason"]
    }])

    st.dataframe(df_bsjp, use_container_width=True)
